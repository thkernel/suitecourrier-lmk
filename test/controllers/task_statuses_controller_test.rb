...
class TaskStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_status" do
    assert_difference('TaskStatus.count') do
      post task_statuses_url, params: { task_status: { description: @task_status.description, name: @task_status.name, status: @task_status.status, uid: @task_status.uid, user_id: @task_status.user_id } }
    end
  ...
  test "should update task_status" do
    patch task_status_url(@task_status), params: { task_status: { description: @task_status.description, name: @task_status.name, status: @task_status.status, uid: @task_status.uid, user_id: @task_status.user_id } }
