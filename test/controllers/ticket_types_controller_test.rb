...
class TicketTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket_type" do
    assert_difference('TicketType.count') do
      post ticket_types_url, params: { ticket_type: { description: @ticket_type.description, name: @ticket_type.name, status: @ticket_type.status, uid: @ticket_type.uid, user_id: @ticket_type.user_id } }
    end
  ...
  test "should update ticket_type" do
    patch ticket_type_url(@ticket_type), params: { ticket_type: { description: @ticket_type.description, name: @ticket_type.name, status: @ticket_type.status, uid: @ticket_type.uid, user_id: @ticket_type.user_id } }
