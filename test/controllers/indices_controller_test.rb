...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post indices_url, params: { index: { description: @index.description, name: @index.name, status: @index.status, user_id: @index.user_id } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { description: @index.description, name: @index.name, status: @index.status, user_id: @index.user_id } }
