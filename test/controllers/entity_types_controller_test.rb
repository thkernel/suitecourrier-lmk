...
class EntityTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity_type" do
    assert_difference('EntityType.count') do
      post entity_types_url, params: { entity_type: { description: @entity_type.description, name: @entity_type.name, status: @entity_type.status, uid: @entity_type.uid, user_id: @entity_type.user_id } }
    end
  ...
  test "should update entity_type" do
    patch entity_type_url(@entity_type), params: { entity_type: { description: @entity_type.description, name: @entity_type.name, status: @entity_type.status, uid: @entity_type.uid, user_id: @entity_type.user_id } }
