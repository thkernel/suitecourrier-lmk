...
class StorageServiceSetting < ApplicationRecord
  belongs_to :user

  has_many :storage_services,  dependent: :destroy
  accepts_nested_attributes_for :storage_services ,  allow_destroy: true
end
